...
model= keras.models.load_model(r'E:\Brianpraise\Brianpraise\lumpy prediction\Cow-Lumpy-Prediction-CNN\CNN.h5')
class_names=['Healthy', 'lumpy Disease']

# WSGI Application
# Defining upload folder path
UPLOAD_FOLDER = os.path.join(r'E:\Brianpraise\Brianpraise\lumpy prediction\Cow-Lumpy-Prediction-CNN\staticFiles', 'uploads')
